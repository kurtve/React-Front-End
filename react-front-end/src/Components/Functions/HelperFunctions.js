...
export const initialActivities = [
    ...
    },
    {
      ...
      notes: 'Lambda School build week',
      rating: 2,
      time: 90,
      created: dummyDateString,
      updated: null
...
export const categories = [
	{id: 0, name: 'Fitness', icon: null},
	{id: 1, name: 'Creative', icon: null},
	{id: 2, name: 'Professional Development', icon: null},
	{id: 3, name: 'Dirty Work', icon: null}
];
